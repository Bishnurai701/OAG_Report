...
public class TreasuryReportService {
	...
	public ServiceResponse GetMaLePa17Report(ReportRequestModel request) {
		StoredProcedureQuery query = entityManager.createStoredProcedureQuery("ACCOUNT_TMS_REPORT.MaLePa17")
				...
				.setParameter(3, request.getAccountId()).setParameter(4, request.getMonthId())
		...
		try {
			...
			StoredProcedureQuery query1 = entityManager
					.createStoredProcedureQuery("ACCOUNT_TMS_REPORT.MaLePa17_Summary")
					.registerStoredProcedureParameter(1, Long.class, ParameterMode.IN)
					.registerStoredProcedureParameter(2, Long.class, ParameterMode.IN)
					.registerStoredProcedureParameter(3, Long.class, ParameterMode.IN)
					.registerStoredProcedureParameter(4, Long.class, ParameterMode.IN)
...
//                .registerStoredProcedureParameter(11, void.class, ParameterMode.REF_CURSOR)
				...
				.setParameter(3, request.getAccountId()).setParameter(4, request.getMonthId())
				.setParameter(5, request.getDateFrom()).setParameter(6, request.getDateTo())
				.setParameter(7, request.getPayeeId()).setParameter(8, request.getHeadId())
				.setParameter(9, request.getLedgerTypeId()).setParameter(10, request.getActivityId());
...
//            List<Object[]> summary = (List<Object[]>) query.getOutputParameterValue(11);
	...
	public ServiceResponse GetMaLePa208Report(ReportRequestModel request) {
		...
		try {
			...
			StoredProcedureQuery query1 = entityManager
					.createStoredProcedureQuery("ACCOUNT_TMS_REPORT.MaLePa208_SUMMARY")
					.registerStoredProcedureParameter(1, Long.class, ParameterMode.IN)
					.registerStoredProcedureParameter(2, Long.class, ParameterMode.IN)
					.registerStoredProcedureParameter(3, Long.class, ParameterMode.IN)
					.registerStoredProcedureParameter(4, Long.class, ParameterMode.IN)
	...
	public ServiceResponse GetMaLePa209Report(ReportRequestModel request) {
		...
		try {
			...
			StoredProcedureQuery query1 = entityManager
					.createStoredProcedureQuery("ACCOUNT_TMS_REPORT.MaLePa209_SUMMARY")
					.registerStoredProcedureParameter(1, Long.class, ParameterMode.IN)
					.registerStoredProcedureParameter(2, Long.class, ParameterMode.IN)
					.registerStoredProcedureParameter(3, Long.class, ParameterMode.IN)
					.registerStoredProcedureParameter(4, Long.class, ParameterMode.IN)
	...
	public ServiceResponse GetMaLePa210Report(ReportRequestModel request) {
		StoredProcedureQuery query = entityManager.createStoredProcedureQuery("ACCOUNT_TMS_REPORT.MaLePa210")
				...
				.setParameter(1, request.getFiscalYearId()).setParameter(2, request.getAgencyId())
				.setParameter(3, request.getAccountId()).setParameter(4, request.getMonthId())
				.setParameter(5, request.getTypeId()).setParameter(6, request.getDateFrom())
	...
	public ServiceResponse GetMaLePa213Report(ReportRequestModel request) {
		...
		try {
			...
			StoredProcedureQuery query1 = entityManager
					.createStoredProcedureQuery("ACCOUNT_TMS_REPORT.MaLePa213_SUMMARY")
					.registerStoredProcedureParameter(1, Long.class, ParameterMode.IN)
					.registerStoredProcedureParameter(2, Long.class, ParameterMode.IN)
					.registerStoredProcedureParameter(3, Long.class, ParameterMode.IN)
					.registerStoredProcedureParameter(4, Long.class, ParameterMode.IN)
