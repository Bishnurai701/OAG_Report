...
@Entity
@Table(name = "OAG_USERS", uniqueConstraints = { @UniqueConstraint(columnNames = "username"),
...
public class User {
	...
	@JoinTable(name = "OAG_USER_ROLES", joinColumns = @JoinColumn(name = "user_id"), inverseJoinColumns = @JoinColumn(name = "role_id"))
